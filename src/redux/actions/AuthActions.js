...
export const signinUserWithFirebase = (user, history) => (dispatch) => {
	...
	// axios.post("https://panel.performa.nz/api/PKLogin/PKMobileLogin", {params:{userName :user.email, password:user.password}},{headers: {
