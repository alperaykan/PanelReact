const en_US = {
   "sidebar.anasayfa" : "Anasayfa",
   "sidebar.ilkSayfa" : "İlk Sayfa",
   "sidebar.etiketler" : "Etiketler",
   "sidebar.yönetim" : "Yönetim",
   "sidebar.performanz":"Performa.nz",
   "sidebar.cihazbilgileri":"Cihaz bilgileri",
   "sidebar.bilgi": "Bilgi",
   "sidebar.kullanicilar": "Kullanıcılar",
   "sidebar.raporlar" : "Raporlar",
   "sidebar.saglikRapor" : "Sağlık Raporları",
   "sidebar.sporcular" : "Sporcular",
   "sidebar.senaryo" : "Senaryo",
   "sidebar.cihazlar" : "Cihazlar",
   "sidebar.yetki" : "Yetki",
