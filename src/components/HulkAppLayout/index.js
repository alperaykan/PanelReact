...
// Actions
import { collapsedSidebarAction, darkModeAction, miniSidebarAction, rtlAction, horizontalMenuAction, chooseThemeAction } from 'redux/actions';
				...
				{ this.state.loading === true ? 
					<div id="loading-bg" className="hk-full-loader" >
						<div className="text-center">
							<Box mb={3}>
								{isDarkModeActive ?
									<img alt="site-logo" width="110" height="30" src={require(`assets/Images/hulk-light.png`).default} />
									:
									<img alt="site-logo" width="110" height="30" src={require(`assets/Images/hulk-dark.png`).default} />
								}
							</Box>
							<CircularProgress />
						</div>
