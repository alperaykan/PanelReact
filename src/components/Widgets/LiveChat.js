									...
									{msg.role === "client" ?
										<Box display="flex" alignItems="flex-start" mb="5px" p="5px 10px 5px  0px">
											<Box pr={2} className="user-thumb">
												<Avatar alt="user-profile" src={require(`assets/Images/avatars/${msg.image}`).default} />
											</Box>
											<Box>
										...
										<Box display="flex" alignItems="flex-start" flexDirection="row-reverse" mb="5px" p="5px 0px 5px  10px">
											<Box pl={2} className="admin-thumb">
												<Avatar alt="admin-thumb" src={require(`assets/Images/avatars/${msg.image}`).default} />
											</Box>
											<Box>
								...
								{typing &&
									<ListItem className={classes.navList}>
										<Box display="flex" alignItems="flex-start">
											<Box pr={2}>
												<Avatar src={require('assets/Images/avatars/user-2.jpg').default} />
											</Box>
											<Box>
