...
class CustomTableWidget extends Component {
	...
	state = {
		columns: [
			{ title: 'Avatar', field: 'imageUrl', render: rowData => <img alt="user-thumb" src={require(`assets/Images/avatars/${rowData.imageUrl}`).default} className="img-50 bdr-rad-50" /> },
						...
						{selectedRow ?
							<>
								<Box mb={2} textAlign="center">
									<Avatar alt="user-thumb" className="avatar-wrap" src={require(`assets/Images/avatars/${selectedRow.imageUrl}`).default} />
									<Box pl={2}>
