...
// Actions
import { setLanguage, rtlAction } from 'redux/actions';
      ...
      return (
         <div>
               ...
               onClick={this.handleClick}
				>
               <img alt="translate-icon" width="35" height="20" src={require(`assets/Images/flags/${locale.icon}`).default} />
                  ...
                  >
                     ...
                     {languages && languages.map((item, index) => (
                        <ListItem component="div" className="top-dropdown-menu--item" key={index} onClick={() => this.onChangeLanguage(item)}>
									<img alt="translate-icon" width="45" height="25" src={require(`assets/Images/flags/${item.icon}`).default} />
